              ...
              <div class="tab-pane" id="settings">
                ...
                <form class="form-horizontal update_user_details" action="<?php echo base_url(); ?>company_profile/update_user_details<?php echo ($session->entity == 'Admin') ? '?company_id='.$company_user_data->id : ''; ?> " method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Username" name="username" id="username" value="<?php echo $company_user_data->username; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-10">
                      <input type="email" class="form-control" placeholder="Email" name="email" id="email" value="<?php echo $company_user_data->email; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputName2" class="col-sm-2 col-form-label">Phone Number</label>
