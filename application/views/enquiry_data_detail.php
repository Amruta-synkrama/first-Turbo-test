...
<section class="content">
    ...
    <div class="row pb-5">
        <div class="col-12">
	        <a class="btn btn-danger reject-something-cust" href="<?php echo base_url(); ?>links/reject?reject_request=<?php echo $_GET['enquiry_id']; ?>&form_id=<?php echo $_GET['form_id']; ?>">Delete</a>
        </div>
    </div>
</section>