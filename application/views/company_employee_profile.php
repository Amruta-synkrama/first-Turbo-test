    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Company Employee Profile</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
      ...
      <div class="col-md-3">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <p class="text-muted text-center">Company Employee</p>
          ...
          <div class="card-body">
            <div class="tab-content">
            	<div class="tab-pane active" id="emp-settings">
            		...
            		<?php endif; ?>
            		<form class="form-horizontal update_employee_details" action="<?php echo base_url(); ?>company_employee_profile/update_employee_details<?php echo($session->entity == 'Admin' || $session->entity == 'Hotel') ? '?emp_id='.$emp_id : ''; ?>" method="post">
            			<div class="form-group row">
            				<label for="inputName" class="col-sm-2 col-form-label">Employee ID</label>
            				<div class="col-sm-10">
            					<input type="text" class="form-control" placeholder="Employee ID" name="emp_id" id="emp_id" value="<?php echo $company_emp_data->emp_id; ?>">
            				</div>
            			</div>
            			<div class="form-group row">
            				<label for="inputName" class="col-sm-2 col-form-label">Location</label>
            				<div class="col-sm-10">
            					<input type="text" class="form-control" placeholder="Location" name="location" id="location" value="<?php echo $company_emp_data->location; ?>">
            				</div>
            			</div>
            			<div class="form-group row">
            	...
            	<div class="tab-pane" id="settings">
            		...
            		<?php endif; ?>
            		<form class="form-horizontal update_user_details" action="<?php echo base_url(); ?>company_employee_profile/update_user_details<?php echo($session->entity == 'Admin' || $session->entity == 'Hotel') ? '?emp_id='.$emp_id : ''; ?>" method="post">
            			<div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="offset-sm-2 col-sm-10">
                    <div class="text-center">
                      <form class="form-horizontal mt-5" action="<?php echo base_url(); ?>company_employee_profile/save_logos<?php echo($session->entity == 'Admin' || $session->entity == 'Hotel') ? '?emp_id='.$emp_id : ''; ?>" method="post" enctype="multipart/form-data">   
                ...
                <?php /* ?>
                <form class="form-horizontal mt-5" action="<?php echo base_url(); ?>company_employee_profile/upload_logo" method="post" enctype="multipart/form-data">
...
$('.upload-result').on('click', function (ev) {
  $uploadCrop.croppie('result', {
    ...
    size: 'viewport'
     ...
     console.log(resp);
    $.ajax({
      url: "<?php echo base_url() ?>company_employee_profile/upload_logos",
      type: "POST",
      data: {"image":resp},
