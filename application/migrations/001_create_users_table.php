...
class Migration_Create_users_table extends CI_Migration
{
    ...
    public function up() {
        ...
        */
        $this->dbforge->add_field([
            ...
            'contact_no'=> ['type' => 'VARCHAR', 'constraint' => '20' ],
        ...
        */
        $this->dbforge->add_field([
            'ID' => [ 'type' => 'INT', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true ],
            'STATE_CODE' => [ 'type' => 'CHAR', 'constraint' => '2' ],
            'STATE_NAME'=> [ 'type' => 'VARCHAR', 'constraint' => '255' ]
        ]);
        $this->dbforge->add_key('ID', true);
        $this->dbforge->create_table('tr_states');
        ...
        */
        $this->dbforge->add_field([
            'ID' => [ 'type' => 'INT', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true ],
            'ID_STATE' => [ 'type' => 'INT', 'constraint' => 11, 'unsigned' => true ],
            'LOCATION'=> [ 'type' => 'VARCHAR', 'constraint' => '255' ],
            'COUNTY'=> [ 'type' => 'VARCHAR', 'constraint' => '255' ],
            'LATITUDE'=> [ 'type' => 'VARCHAR', 'constraint' => '255' ],
            'LONGITUDE'=> [ 'type' => 'VARCHAR', 'constraint' => '255' ],
        ]);
        $this->dbforge->add_key('ID', true);
    ...
    public function down() {
        ...
        $this->dbforge->drop_table('tr_states', true);
